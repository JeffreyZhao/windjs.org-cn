...
我们现在想要解决的是“流程控制”问题，那么说起在JavaScript中进行流程控制，有什么能比JavaScript语言本身更为现成的解决方案呢？在我看来，**流程控制并非是一个理应使用类库来解决的问题，它应该是语言的职责**。只不过在某些时候，我们无法使用语言来表达逻辑或是控制流程，于是推而求其次地使用“类库”来解决这方面的问题。
